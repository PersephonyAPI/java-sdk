...
public class ApplicationCreateOptionsTest {
    ...
    @Then("^set (alias|voiceUrl|voiceFallbackUrl|callConnectUrl|statusCallbackUrl|smsUrl|smsFallbackUrl) to (.*) in ApplicationCreateOptions$")
    ...
    @Then("^check that (alias|voiceUrl|voiceFallbackUrl|callConnectUrl|statusCallbackUrl|smsUrl|smsFallbackUrl) is (.*) in ApplicationCreateOptions$")
